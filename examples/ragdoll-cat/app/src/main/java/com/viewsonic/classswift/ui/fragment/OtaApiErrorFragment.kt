...
class OtaApiErrorFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            tvTitle.text = getString(R.string.autoupdate_check_failed)
            tvDescription.text = getString(R.string.autoupdate_error_msg_unable_to_check)
        }
        initClickAction()
    }
