...
class RecordSeatListAdapter : ListAdapter<TaskResultInfo, RecyclerView.ViewHolder>(diffCallback) {

    private var currentTaskId: String = ""
    private var itemEventListener: RecordItemEventListener? = null

    interface RecordItemEventListener {
        fun onThumbnailClicked(data: TaskResultInfo)
    ...
    fun clearAll() {
        submitList(emptyList<TaskResultInfo>())
    }
    ...
    fun setRecordItemEventListener(listener: RecordItemEventListener) {
