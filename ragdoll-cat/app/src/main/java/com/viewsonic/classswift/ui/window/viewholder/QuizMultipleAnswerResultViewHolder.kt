...
class QuizMultipleAnswerResultViewHolder(private val binding: ItemQuizMultipleAnswerResultBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        with(binding) {
            ...
            when (info.answerResultState) {
                ...
                AnswerResultState.CORRECT -> {
                    ...
                    csMultipleAnswerIcon.isVisible = true
