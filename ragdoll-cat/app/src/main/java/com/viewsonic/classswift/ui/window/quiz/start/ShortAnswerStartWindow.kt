...
import com.viewsonic.classswift.databinding.WindowShortAnswerStartQuizBinding
...
class ShortAnswerStartWindow(
    private val applicationContext: Context
) : IWindow<WindowShortAnswerStartQuizBinding>, RandomDrawWidget.RandomDrawViewListener, QuizAnswerResultAdapter.OnItemInteractionListener, ShortAnswerResultDetailWidget.OnInteractionListener {
    ...
    private val studentQuizAnswerResultAdapter: QuizAnswerResultAdapter = QuizAnswerResultAdapter(this@ShortAnswerStartWindow)

    override var tag: WindowTag = WindowTag.SHORT_ANSWER_START_QUIZ
    override var size: SizeInPixels = SizeInPixels(
        WindowManager.LayoutParams.WRAP_CONTENT,
        WindowManager.LayoutParams.WRAP_CONTENT
    )

    override val binding: WindowShortAnswerStartQuizBinding =
        WindowShortAnswerStartQuizBinding.inflate(
            LayoutInflater.from(
                ContextThemeWrapper(
                    applicationContext,
    ...
    private fun initUI() {
        ...
        binding.widgetShortAnswerResultDetail.setOnInteractionListener(this@ShortAnswerStartWindow)
